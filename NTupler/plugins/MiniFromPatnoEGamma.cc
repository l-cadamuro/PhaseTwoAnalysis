...
// Class:      MiniFromPatnoEGamma
// 
/**\class MiniFromPatnoEGamma MiniFromPatnoEGamma.cc PhaseTwoAnalysis/NTupler/plugins/MiniFromPatnoEGamma.cc
...
class MiniFromPatnoEGamma : public edm::one::EDAnalyzer<edm::one::SharedResources, edm::one::WatchRuns>  {
  public:
    explicit MiniFromPatnoEGamma(const edm::ParameterSet&);
    ~MiniFromPatnoEGamma();
...
//
MiniFromPatnoEGamma::MiniFromPatnoEGamma(const edm::ParameterSet& iConfig):
...
MiniFromPatnoEGamma::~MiniFromPatnoEGamma()
{
...
// ------------ method to fill gen level pat -------------
  void
MiniFromPatnoEGamma::genAnalysis(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
// ------------ method to fill reco level pat -------------
  void
MiniFromPatnoEGamma::recoAnalysis(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
// ------------ method called for each event  ------------
  void
MiniFromPatnoEGamma::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
bool 
MiniFromPatnoEGamma::isME0MuonSelNew(const reco::Muon& muon, double dEtaCut, double dPhiCut, double dPhiBendCut, edm::EventSetup const& iSetup)
{
...
// ------------ method called once each job just before starting event loop  ------------
  void 
MiniFromPatnoEGamma::beginJob()
{
}

// ------------ method called once each run ----------------
void
MiniFromPatnoEGamma::beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup)
{
  edm::ESHandle<ME0Geometry> hGeom;
  iSetup.get<MuonGeometryRecord>().get(hGeom);
  ME0Geometry_ =( &*hGeom);
...
// ------------ method called when ending the processing of a run  ------------
  void
MiniFromPatnoEGamma::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called once each job just after ending the event loop  ------------
  void 
MiniFromPatnoEGamma::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
MiniFromPatnoEGamma::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MiniFromPatnoEGamma);
