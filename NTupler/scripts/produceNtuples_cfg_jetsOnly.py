...
moduleName = "MiniFromPat_jetonly"
if (options.inputFormat.lower() == "reco"):
...
if options.skim:
    if (options.inputFormat.lower() == "reco"):
        if options.updateJEC:
            ...
            process.p = cms.Path(process.weightCounter * process.puSequence * process.ak4PFPuppiL1FastL2L3CorrectorChain * process.ak4PUPPIJetsL1FastL2L3 * process.preYieldFilter * process.ntuple)
        else:
        ...
        if options.updateJEC:
            ...
            process.p = cms.Path(process.weightCounter*process.patJetCorrFactorsUpdatedJECAK4PFPuppi * process.updatedPatJetsUpdatedJECAK4PFPuppi *process.preYieldFilter* process.ntuple)
        else:
    ...
    if (options.inputFormat.lower() == "reco"):
        if options.updateJEC:
            ...
            process.p = cms.Path(process.weightCounter * process.puSequence * process.ak4PFPuppiL1FastL2L3CorrectorChain * process.ak4PUPPIJetsL1FastL2L3 * process.ntuple)
        else:
            # process.p = cms.Path(process.weightCounter * process.puSequence * process.phase2Egamma * process.ntuple)
            process.p = cms.Path(process.weightCounter * process.puSequence * process.ntuple)
    else:
        if options.updateJEC:
            ...
            process.p = cms.Path(process.weightCounter*process.patJetCorrFactorsUpdatedJECAK4PFPuppi * process.updatedPatJetsUpdatedJECAK4PFPuppi * process.ntuple)
	else:    
            # process.p = cms.Path(process.weightCounter*process.phase2Egamma*process.ntuple)
            process.p = cms.Path(process.weightCounter*process.ntuple)
